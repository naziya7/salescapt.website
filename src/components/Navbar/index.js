        ...
        <>
            <IconContext.Provider value={{ color: '#fff' }}>
                <Nav scrollNav={scrollNav}>
                    <NavbarContainer>
                        <NavLogo to="/" onClick={toggleHome}> SalesCaptain </NavLogo>
                        ...
                        <NavMenu>
                            ...
                            <NavItem>
                                ...
                                spy={true}
                                activeClass='active'
                                exact='true'> Get Started </NavLinks>
                            </NavItem>
                        </NavMenu>
                        <NavBtn>
